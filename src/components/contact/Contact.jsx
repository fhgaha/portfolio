...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_llo4qxt', 'template_5xu9bzs', form.current, '-xk5Q1KmyzwiFqdc-')
      .then((result) => {
      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <a href="mailto:antsy1992@gmail.com" target='_blank' rel="noreferrer">Send a message</a>
          </article>
